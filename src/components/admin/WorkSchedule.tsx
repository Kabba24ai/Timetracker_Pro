                  ...
                  {selectedEmployees.map(employeeId => {
                    ...
                    return (
                      <tr key={employeeId} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-2 px-1 bg-white sticky left-0 z-10 border-r border-gray-200 w-[100px]">
                    ...
                    <th className="text-left py-4 px-2 font-medium text-gray-900 bg-gray-50 sticky left-0 z-10 min-w-[100px] w-[100px]">
