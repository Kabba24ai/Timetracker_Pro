/*
  ...
  1. Creates Demo Auth Users
    ...
    - Employee user: john@demo.com / demo123
...
-- Function to create demo user and employee record
CREATE OR REPLACE FUNCTION create_demo_user_and_employee(
  p_email text,
  p_password text,
  p_first_name text,
  p_last_name text,
...
SELECT create_demo_user_and_employee(
  'admin@demo.com',
  'admin123',
  'Admin',
  'Demo',
...
DROP FUNCTION IF EXISTS create_demo_user_and_employee;
